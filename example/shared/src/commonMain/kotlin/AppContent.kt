    ...
    Row {
        if (appState.showNavigationBar) {
            NavigationRail(
                ...
                mode = NavigationDisplayMode.entries[appState.navigationRailMode],
            ) {
    ...
    AnimatedVisibility(
        ...
        AnimatedVisibility(
            ...
            Box(
                ...
                NavigationBar(
                    modifier = Modifier,
                    mode = NavigationDisplayMode.entries[appState.navigationBarMode],
                ) {
                    navigationItems.forEachIndexed { index, item ->
                        NavigationBarItem(
                            selected = page == index,
        ...
        AnimatedVisibility(
            ...
            Box(
                ...
                FloatingNavigationBar(
                    mode = NavigationDisplayMode.entries[appState.floatingNavigationBarMode],
